...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["tipo"]))){
        $tipo_err = "Please fill type.";     
    }
    else{
        $tipo = trim($_POST["tipo"]);
    }   
    
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($tipo_err)){
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <div class="form-outline mb-3">
                                         ...
                                         <!-- User type -->
                                         <div class="form-outline mb-3">
                                            <select class="form-select <?php echo (!empty($tipo_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $tipo; ?>" aria-label="Default select example" name="tipo" required>
                                                <option selected value="">Selecione o tipo de utilizador</option>
